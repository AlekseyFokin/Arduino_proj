...
#define TIME_TO_WORK_INIT 5
#define TIME_TO_REST_ADDR 210
#define TIME_TO_REST_INIT 15
...
unsigned long currentMillis=millis();// текущее время
 long totalTimeToWork=((long)timeToWork)*1000*60;//приведение типов таймаутов
 long totalTimeToRest=((long)timeToRest)*1000*60;
